            ...
            const getRecords = async (history) => {
                try {
                    ...
                    const responseQuestions = await axios.get(
                        `https://sbpmb-express.amisbudi.cloud/questions?category=${history.category_id}`
                    );
            ...
            const resetRecord = async (identityUser, idCategory) => {
                ...
                if (message) {
                    ...
                    if (input == identityUser) {
                        await axios.delete(`https://sbpmb-express.amisbudi.cloud/histories/${identityUser}/${idCategory}`)
                            .then((response) => {
